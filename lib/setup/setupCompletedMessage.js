...
hesitate to contact us if required
  ...
  console.log(`
**  Reminder: when running locally or deploying to Cloud Foundry remember to update
    the DB kind in your package.json accordingly 
    
    ${this.appName} > package.json > cds.requires.db.kind = ${blue(
    'sqlite/sql/hana'
  )}
